...
namespace task2
{
    ...
    public class Matrix:IEnumerable<int>
    {
        ...
        public int ViewMatrix { get => viewMatrix; set => viewMatrix = value; }
        ...
        public IEnumerator<int> GetEnumerator()
        {
            switch (viewMatrix)
            {
                ...
                default:
                    {
                        throw new IndexOutOfRangeException("inccorect number of kind view matrix");
                    }
                    break;
            }
        }
