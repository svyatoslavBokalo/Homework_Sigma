...
namespace HomeWork2_ProductAndMatrix
{
    internal class Meat: Product
    {
        ...
        static public bool operator ==(Meat? meat1, Meat? meat2)
        {
            if (meat1.Price == meat2.Price && meat1.Weight == meat2.Weight && meat1.categoryOfMeat == meat2.categoryOfMeat && meat1.typeOfMeat == meat2.typeOfMeat)
            {
                return true;
            }
            return true;
