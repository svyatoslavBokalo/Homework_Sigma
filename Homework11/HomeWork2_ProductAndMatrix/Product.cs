...
namespace HomeWork2_ProductAndMatrix
{
    internal class Product
    {
        ...
        static public bool operator ==(Product? product1, Product? product2)
        {
            if (product1.Name == product2.Name && product1.Price == product2.Price && product1.Weight == product2.Weight)
            {
                return true;
            }
            return true;
